...
<head>
    ...
    <link href="${rootPath}/static/css/bootstrap.min.css" rel="stylesheet">
    <link href="${rootPath}/static/font-awesome/css/font-awesome.css" rel="stylesheet">
    <link href="${rootPath}/static/css/plugins/toastr/toastr.min.css" rel="stylesheet">
    <link href="${rootPath}/static/css/plugins/gritter/jquery.gritter.css" rel="stylesheet">
    <link href="${rootPath}/static/css/plugins/multiselect/tree-multiselect.min.css" rel="stylesheet">
    <link href="${rootPath}/static/css/animate.css" rel="stylesheet">
...
<!-- 全局 scripts -->
<script src="${rootPath}/static/js/jquery-2.1.1.js"></script>
<script src="${rootPath}/static/js/bootstrap.js"></script>
<script src="${rootPath}/static/js/wuling.js"></script>
<script src="${rootPath}/static/js/plugins/pace/pace.min.js"></script>
<script src="${rootPath}/static/js/plugins/slimscroll/jquery.slimscroll.min.js"></script>
<script src="${rootPath}/static/js/plugins/metisMenu/jquery.metisMenu.js"></script>
<script src="${rootPath}/static/js/plugins/multiselect/tree-multiselect.min.js"></script>
<!-- 插件 scripts -->
<script src="${rootPath}/static/js/plugins/toastr/toastr.min.js" async></script>
<!---顶部弹出提示--->
