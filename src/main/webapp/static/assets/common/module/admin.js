...
layui.define(['layer'], function (exports) {
    ...
    var admin = {
        ...
        flexible: function (expand) {
            ...
            if (expand) {
                $('.layui-layout-admin').removeClass('admin-nav-mini').parents('#LAY_app').removeClass('layadmin-side-shrink');
            } else {
                $('.layui-layout-admin').addClass('admin-nav-mini').parents('#LAY_app').addClass('layadmin-side-shrink');
            }
    ...
    admin.events = {
        ...
        theme: function () {
            ...
            admin.popupRight({
                type: 2,
                content: url ? url : nstr_module.ctxPath + '/system/theme'
            });
        },
        // 打开便签
        note: function () {
        ...
        message: function () {
            ...
            admin.popupRight({
                type: 2,
                content: url ? url : nstr_module.ctxPath + '/system/message'
            });
        },
        // 全屏
